...
MTable.New = function(Name, Scope)
    assert((type(Name) == "string" and Name ~= ""), "DataStore.lua -> Improper Name")
    assert((type(Scope) == "string" and Scope ~= ""), "DataStore.lua -> Improper Scope")
...
MTable:SetData = function(Name, Value)
    assert((type(Name) == "string" and Name ~= ""), "DataStore.lua -> SetData: Improper Key")
...
MTable:DelData = function(Name)
    assert((type(Name) == "string" and Name ~= ""), "DataStore.lua -> DelData: Improper Key")
    local success, err = pcall(function()
...
MTable:UpdData = function(Name, func)
    assert((type(Name) == "string" and Name ~= ""), "DataStore.lua -> UpdData: Improper Key")
    local success, err = pcall(function()
